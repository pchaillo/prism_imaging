...
function time = time_from_peaks2(mzXMLStruct,threshold_begin,t_step,min_threshold)
...
fprintf('Mean time between peaks : %f seconds \n Attention, valeur peut être fausse si la fréquence déchatillonage est élevéé \n', time);
