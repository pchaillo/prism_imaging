...
function [ carte_x,carte_y,carte_z,bio_map  ] = fix_border_3(carte_x,carte_y,carte_z,bio_map,bio_ind)
...
if l_bio == 2
    ...
    bio_map(si(1)+i,:) = NaN;
elseif l_bio == 3
    bio_map(:,si(2)+i,:) = NaN;%[NaN NaN NaN];
    bio_map(si(1)+i,:,:) = NaN;%[NaN NaN NaN];
end
