...
% Renvoie la hauteur mesurée par le capteur, en se basant sur sur la valeur lue sur les bornes (lecture de la pin arduino (variable ard et fonction lecture_capteur() ) et sur le tableau d'étalonnage new_tab. 
