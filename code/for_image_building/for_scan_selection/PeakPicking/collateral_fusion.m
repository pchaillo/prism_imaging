function all_scans = collateral_fusion(app, all_scans, first_point_indice, last_selected_point_indice, noise_threshold, selected_indices, fusion_indices, t_step, deleted_indices )
...
for i = 1 : length(selected_indices)
    selected_time_list(i) = all_scans(selected_indices(i)).retentionTime;
end
...
for i = 1 : length(selected_over_noise_inds)
    if selected_over_noise_inds(i) < 0
        ...
        ind = ind + 1;
        scan = all_scans(selected_over_noise_inds(i));
