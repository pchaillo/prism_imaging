...
tail = csv.iloc[11:, :]
bp = csv.iloc[10, :]
bp_norm = bp/bp.max()  # Max and sum methods both work for this, can't tell which one is best. Max makes inherently
                    # more sense to me however.

for data in tail:
    tail[data] = tail[data]/bp_norm[data]
