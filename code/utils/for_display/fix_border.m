...
% ENG : Adds valueless edges to avoid losing information at the ends during display

% FR : Ajoute des bords sans valeur pour ne pas perdre les informations aux
