...
scan_1.retentionTime = scan_1.retentionTime;
scan_1.totIonCurrent = scan_1.totIonCurrent; 
scan_1.num = scan_1.num;
scan_2.centroided = -1;

scan_1.peaks.mz = [ scan_1.peaks.mz ; scan_2.peaks.mz ];

scan_1.ionisationEnergy = scan_1.ionisationEnergy + scan_2.ionisationEnergy ;
